...
def test_get_value_id_1():
    ...
    assert response.json() == {
        ...
        "description": "Valuing people more highly than processes or tools is easy to understand because it is the people who respond to business needs and drive the development process.",
        "id": 1,
    }
